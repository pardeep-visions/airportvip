<?php
add_action('vc_before_init', 'your_name_fooeventsallblock');
function your_name_fooeventsallblock() {
	vc_map(
		array(
			"name" => __("Foo Events All Cards", "my-text-domain"),
			"base" => "fooeventsallblock",
			"class" => "",
...
add_shortcode('fooeventsallblock', 'fooeventsallblock_func');
function fooeventsallblock_func($atts, $content = null, $servicetitle) { 
    ob_start(); ?>
