<?php
add_action('vc_before_init', 'your_name_mailchimpinline');
function your_name_mailchimpinline()
{
    vc_map(
        array(
            "name" => __("MailChimp Inline", "my-text-domain"),
            "base" => "mailchimpinline",
            "class" => "",
...
add_shortcode('mailchimpinline', 'mailchimpinline_func');
function mailchimpinline_func($atts, $content = null, $servicetitle)
{
    ob_start();  ?>
