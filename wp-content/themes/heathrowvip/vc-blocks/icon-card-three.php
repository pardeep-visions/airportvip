<?php
add_action('vc_before_init', 'servicecard_integrateWithVC');
function servicecard_integrateWithVC()
{
    vc_map(
        array(
            "name" => __("Service Card", "my-text-domain"),
            "base" => "servicecard",
            "class" => "",
...
add_shortcode('servicecard', 'servicecard_func');
function servicecard_func($atts, $content = null, $servicetitle)
{
