...
function print_woocommerce_airport_search_code()
{
    ...
    <script src="<?php echo get_theme_file_uri('woocommerce-bookings/airport/assets/js/airport.js'); ?>" defer></script>

    <?php

}
include_once(__DIR__.'/vc-blocks/airport-selector.php');