...
class Controller extends WC_REST_Products_Controller {
	...
	/**
	 * Delete a single product (or product variation).
	 *
	 * @param WP_REST_Request $request Full details about the request.
	 *
