...
class Actions {
	...
	public static function initialize() {
		add_filter( 'plugin_action_links_' . YAYMAIL_ADDON_WOO_BOOKING_PLUGIN_BASENAME, array( __CLASS__, 'yaymail_addon_add_action_links' ) );
	...
	public static function yaymail_addon_custom_plugin_row_meta( $plugin_meta, $plugin_file ) {
		...
		if ( strpos( $plugin_file, YAYMAIL_ADDON_WOO_BOOKING_PLUGIN_BASENAME ) !== false ) {
			$new_links = array(
