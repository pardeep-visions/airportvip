...
class YayMailAddonLicense {
	...
	public static function yaymail_addon_license( $plugins ) {
		$plugin_data    = YAYMAIL_ADDON_WOO_BOOKING_PLUGIN_DATA;
		...
		$plugins[]      = array(
			'name'     => $plugin_name,
			'slug'     => $plugin_slug,
			'dir_path' => YAYMAIL_ADDON_WOO_BOOKING_PLUGIN_PATH,
			'basename' => YAYMAIL_ADDON_WOO_BOOKING_PLUGIN_BASENAME,
			'url'      => YAYMAIL_ADDON_WOO_BOOKING_LINK_URL,
			'file'     => __FILE__,
